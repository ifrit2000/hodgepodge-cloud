...
containerVolumeDir=F:/Dev/containerVolume/dev
...
docker create --name dev-consul --privileged=true --network ${network_name} --ip 172.18.0.3 --volume ${containerVolumeDir}/consul:/consul consul:1.4.0 consul agent -server -bootstrap-expect 1 -data-dir /consul/data -client 0.0.0.0 -bind 172.18.0.3 -ui
