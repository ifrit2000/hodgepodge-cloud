...
(
  ...
  TOPIC_STATUS VARCHAR(4) DEFAULT '0' COMMENT '-1 processing 0 未处理 1 已处理 2 图片异常 3 种子异常 4 整体异常',
...
alter table TOPIC_INFO add constraint UK_TOPIC_INFO unique (TOPIC_URL);
